...
float ctrlpoints[9][3][3] = {
	{ { -250.0, 0, -200.0 }, { -175.0, 0, -200.0 }, { -100.0, 0, -200.0 } },
	{ { -250.0, 0, 0.0 }, { -175.0, 0, 0.0 }, { -100.0, 0, 0.0 } },
	{ { -250.0, 0, 200.0 }, { -175.0, 0, 200.0 }, { -100.0, 0, 200.0 } },

	{ { -100.0, 0, -200.0 }, { 0.0, 0, -200.0 }, { 100.0, 0, -200.0 } },
	{ { -100.0, 0, 0.0 }, { 0.0, 0, 0.0 }, { 100.0, 0, 0.0 } },
	{ { -100.0, 0, 200.0 }, { 0.0, 0, 200.0 }, { 100.0, 0, 200.0 } },

	{ { 100.0, 0, -200.0 }, { 175.0, 0, -200.0 }, { 250.0, -0, -200.0 } },
	{ { 100.0, 0, 0.0 }, { 175.0, 0, 0.0 }, { 250.0, 0, 0.0 } },
	{ { 100.0, 0, 200.0 }, { 175.0, 0, 200.0 }, { 250.0, 0, 200.0 } },
};


GLfloat towerctrlpoints[6][3][3] = { 
	{ { -100.0, 0, -200.0 }, { 0.0, 0, -200.0 }, { 100.0, 0, -200.0 } },
	{ { -100.0, 0, 0.0 }, { 0.0, 0, 0.0 }, { 100.0, 0, 0.0 } },
	{ { -100.0, 0, 200.0 }, { 0.0, 0, 200.0 }, { 100.0, 0, 200.0 } },

	{ { -100.0, 50, -200.0 }, { 0.0, 50, -200.0 }, { 100.0, 50, -200.0 } },
	{ { -100.0, 50, 0.0 }, { 0.0, 50, 0.0 }, { 100.0, 50, 0.0 } },
	{ { -100.0, 50, 200.0 }, { 0.0, 50, 200.0 }, { 100.0, 50, 200.0 } },
};


float moveY[9] = { 0, };
float towermoveY[9] = { 0, };
	...
	glPushMatrix(); //여기에 추가하십시오
		...
		glPushMatrix();
			...
			for (int i = 0; i < 3; i++)
			{
				...
				glMap2f(GL_MAP2_VERTEX_3, 0.0, 1.0, 3, 3, 0.0, 1.0, 9, 3, &ctrlpoints[i * 3][0][0]);
		...
		glPushMatrix();
			...
			for (int i = 0; i < 2; i++)
			{
				glMap2f(GL_MAP2_VERTEX_3, 0.0, 1.0, 3, 3, 0.0, 1.0, 9, 3, &towerctrlpoints[i * 3][0][0]);
				glEnable(GL_MAP2_VERTEX_3);
			...
			glBegin(GL_POINTS);
				...
				for (int i = 0; i < 6; i++)
					for (int j = 0; j < 3; j++)
						glVertex3fv(towerctrlpoints[i][j]);
				glEnd();
...
void Keyboard(unsigned char key, int x, int y)
{
	...
	{
		for (int i = 0; i < 6; i++)
			towerctrlpoints[i][1][1] += towermoveY[i];
	}
